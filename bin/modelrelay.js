...
import { getAutostartStatus, installAutostart, uninstallAutostart } from '../lib/autostart.js'
...
function printHelp() {
  ...
  console.log('  modelrelay autostart [--install|--uninstall|--status]')
  console.log('')
  console.log('Flags:')
...
function runAutostartAction(action) {
  if (action === 'install') return installAutostart()
